...
const skills = [
  ...
  { name: 'NestJS', src: '/images/nestjs4-removebg-preview.png' },
...
export default function SkillsSection() {
  return (
    <section id="skills" className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-300 to-purple-400">
