...
const styles = {
  sectionSubText:
    "sm:text-[19px] text-[14px] text-secondary uppercase tracking-wider flex justify-center",
  sectionHeadText:
    ...
    >
      <div className="max-w-7xl mx-auto relative z-10 mt-16">
        ...
        <motion.p
          ...
          className="mt-4 text-secondary text-[17px] text-center leading-[30px] mb-14"
        >
